...
import './PriceBox.css'
const PriceBox = ({ planName, bgColor, btnColor, logo, price, inCluded, marginTop }) => {
    return (
        <div className={`price-box col-11 col-lg-4 mx-lg-1 mx-0 col-md-5 my-lg-0 my-4 ` + marginTop} style={{ backgroundColor: bgColor }}>
            ...
            <h2>{planName}</h2>
            <p>ما در تیم پرفکت کد قصد داریم با بروز ترین امکانات موجود سایت شمارو طراحی کنیم .</p>
